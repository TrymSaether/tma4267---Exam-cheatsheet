...
% Landscape and no margins
\geometry{paperwidth=11in,paperheight=8.5in,margin=0.25in,landscape}
...
\begin{center}
    {\color{blue} \Large{\textbf{Linear Statistical Modelling\\Cheatsheet}}}
\end{center}
